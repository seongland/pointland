...
struct GPSTime
{
	...
	{
		return (this->second - other.second) + (this->week - other.week) * MAX_SECOND;
	}
...
struct PoseEuler
{
	...
	Vector operator * (Vector& other)
	{
		...
		result.x = e.matrix[0][0] * other.x + e.matrix[0][1] * other.y + e.matrix[0][2] * other.z;
		result.y = e.matrix[1][0] * other.x + e.matrix[1][1] * other.y + e.matrix[1][2] * other.z;
		result.z = e.matrix[2][0] * other.x + e.matrix[2][1] * other.y + e.matrix[2][2] * other.z;
	...
	Point operator * (Point& other)
	{
		...
		result.p.x = e.matrix[0][0] * other.p.x + e.matrix[0][1] * other.p.y + e.matrix[0][2] * other.p.z;
		result.p.y = e.matrix[1][0] * other.p.x + e.matrix[1][1] * other.p.y + e.matrix[1][2] * other.p.z;
		result.p.z = e.matrix[2][0] * other.p.x + e.matrix[2][1] * other.p.y + e.matrix[2][2] * other.p.z;
...
public:
	SPointConvertor();
	std::vector<Point2d> xyzToImageCoor(CameraInfo camera, PoseEuler pos, std::vector<Point> points);
